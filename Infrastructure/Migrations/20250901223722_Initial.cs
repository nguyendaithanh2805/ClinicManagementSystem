        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    Cost = table.Column<decimal>(type: "decimal(15,0)", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_MedicalService", x => x.Id);
                    table.ForeignKey(
                        name: "FK_MedicalService_Specialty_SpecialtyId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_ChangeLog_Staff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TreatmentMethod = table.Column<string>(type: "nvarchar(500)", maxLength: 500, nullable: true),
                    RequiresTest = table.Column<bool>(type: "bit", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_PatientMedicalRecord", x => x.Id);
                    table.ForeignKey(
                        name: "FK_PatientMedicalRecord_Patient_PatientId",
                        column: x => x.PatientId,
                        principalTable: "Patient",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_PatientMedicalRecord_Staff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Prescription_PatientMedicalRecord_PatientMedicalRecordId",
                        column: x => x.PatientMedicalRecordId,
                        principalTable: "PatientMedicalRecord",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Symptom_PatientMedicalRecord_PatientMedicalRecordId",
                        column: x => x.PatientMedicalRecordId,
                        principalTable: "PatientMedicalRecord",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_TestResult_PatientMedicalRecord_PatientMedicalRecordId",
                        column: x => x.PatientMedicalRecordId,
                        principalTable: "PatientMedicalRecord",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_TestResult_Staff_StaffId",
                        column: x => x.StaffId,
                        principalTable: "Staff",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Restrict);
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Restrict);
                    table.ForeignKey(
                        name: "FK_Invoice_Prescription_Id",
                        column: x => x.Id,
            ...
            migrationBuilder.CreateIndex(
                name: "IX_ChangeLog_StaffId",
                table: "ChangeLog",
                column: "StaffId");

            migrationBuilder.CreateIndex(
                name: "IX_MedicalService_SpecialtyId",
                table: "MedicalService",
                column: "SpecialtyId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientMedicalRecord_PatientId",
                table: "PatientMedicalRecord",
                column: "PatientId");

            migrationBuilder.CreateIndex(
                name: "IX_PatientMedicalRecord_StaffId",
                table: "PatientMedicalRecord",
                column: "StaffId");

            migrationBuilder.CreateIndex(
                name: "IX_Prescription_PatientMedicalRecordId",
                table: "Prescription",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Symptom_PatientMedicalRecordId",
                table: "Symptom",
                column: "PatientMedicalRecordId");

            migrationBuilder.CreateIndex(
                name: "IX_TestResult_PatientMedicalRecordId",
                table: "TestResult",
                column: "PatientMedicalRecordId");

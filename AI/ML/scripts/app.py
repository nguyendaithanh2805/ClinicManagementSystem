...
# ============================================
# 🧠 HÀM TẢI MÔ HÌNH VÀ CÁC FILE MAPPING
# ============================================
def load_models():
    """
    Tải toàn bộ mô hình, mapping và danh sách đặc trưng phục vụ dự đoán.
    ...
    try:
        ...
        print("✅ Đã tải thành công tất cả mô hình và mapping.")
        return (
...
# Xác định danh sách cột đặc trưng
feature_cols = (
